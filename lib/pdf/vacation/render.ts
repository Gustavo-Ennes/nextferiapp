...
const drawHalfPage = async ({
  ...
  console.log("🚀 ~ drawHalfPage ~ vacation:", vacation)
  console.log("🚀 ~ drawHalfPage ~ vacation.daysQtd:", vacation.daysQtd)
  console.log("🚀 ~ drawHalfPage ~ vacation.duration:", vacation.duration)
